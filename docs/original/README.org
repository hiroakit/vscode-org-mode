...
#+NOTE: This document describes the original project proposal and early development plan.
#+NOTE: It is kept for historical reference and does not reflect the current state of the extension.
* About
